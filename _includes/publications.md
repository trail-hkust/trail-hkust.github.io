...
<li>
  <div class="publication-entry" style="margin-bottom:40px;">

    <div class="col-sm-12 abbr" style="position:relative;text-align:center;height:260px;display:flex;align-items:center;justify-content:center;overflow:hidden;margin-bottom:15px;">

      <img src="{{ link.image2 }}" class="teaser img-fluid z-depth-1" style="max-width:100%;max-height:100%;object-fit:contain;">

      <abbr class="badge" style="position:absolute;top:10px;left:10px;background:#002D72;color:white;padding:5px 10px;font-size:12px;">
        {{ link.conference_short2 }}
      </abbr>

    </div>

    <div class="col-sm-12" style="padding:10px 15px;text-align:center;">
      ...
      <div class="author" style="margin-bottom:8px;">{{ link.authors2 }}</div>

      <div class="periodical" style="margin-bottom:12px;"><em>{{ link.conference2 }}</em></div>
